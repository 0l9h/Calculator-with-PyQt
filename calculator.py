...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_PLUS.clicked.connect(self.addition)
       # self.pushButton_MINUS.clicked.connect(self.button_clicked)
       # self.pushButton_MULTIPLY.clicked.connect(self.button_clicked)
       # self.pushButton_DIVIDE.clicked.connect(self.button_clicked)
       # self.pushButton_EQUALS.clicked.connect(self.button_clicked)
    ...
    def getValue(self):
        self.var = int(self.line)
        self.values_list.append(self.var)
